...
var asteroidImgs = ['img/asteroid0.png', 'img/asteroid1.png', 'img/asteroid2.png', 'img/spinningAsteroid.gif', 'img/spinningAsteroid.gif'];
var asteroidImg = asteroidImgs[Math.floor(Math.random() * 5)];
let highScore = 0;
let currentScore = 0;
let lifeCount = 0;
